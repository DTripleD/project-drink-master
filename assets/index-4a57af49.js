...
`;const lW=()=>x.jsx(x.Fragment,{children:x.jsx(kn,{children:x.jsxs(x.Fragment,{children:[x.jsx(as,{title:"Favorites"}),x.jsx(aW,{})]})})}),uW=A.div`
  width: 100%;
  color: ${e=>e.theme.colors.white};
...
`,YC=({title:e})=>x.jsx("div",{children:x.jsx(cW,{children:e})});YC.propTypes={title:Q.string};const dW=A.p`
  font-size: 12px;
...
`,gW=()=>{const{recipeId:e}=jx();b.useState(null);const[t,n]=b.useState(!1),r=nt(UC),i=qn();return b.useEffect(()=>{i(Io())},[i]),b.useEffect(()=>{const o=r.some(s=>s._id===e);n(o)},[r,e]),x.jsx("div",{children:t?x.jsx(ux,{type:"button",onClick:()=>i(Xs(e)),children:"Remove from favorites"}):x.jsx(ux,{type:"button",onClick:()=>i(Jl(e)),children:"Add to favorite recipe"})})},XC=({ingridients:{drink:e,glass:t,drinkThumb:n,description:r}})=>x.jsxs(mW,{children:[x.jsxs("div",{children:[x.jsx(dW,{children:t}),x.jsx(YC,{title:e}),x.jsx(fW,{children:r||"Lorem ipsum dolor sit amet consectetur adipisicing elit. Praesentium debitis optio deserunt dignissimos commodi nisi expedita itaque dolor provident. Atque labore, corrupti totamaccusantium omnis alias vero. Itaque eos ullam aut rerum quam. Nontemporibus vel dolore similique, suscipit amet."}),x.jsx(gW,{})]}),x.jsx(hW,{children:x.jsx(pW,{src:n||"/plug-m.png",alt:e})})]});XC.propTypes={ingridients:Q.object,drink:Q.string,glass:Q.string,drinkThumb:Q.string,description:Q.string};const cx=A.p`
  font-size: 16px;
  color: rgba(243, 243, 243, 0.5);
...
`,JC=({ingridients:e})=>{if(!e)return x.jsx(cx,{children:"Something went wrong,try again..."});const t=e.ingredients;return x.jsxs(SW,{children:[x.jsx(cx,{children:"Ingredients"}),x.jsx(xW,{children:t.map((n,r)=>x.jsxs(EW,{children:[x.jsx(yW,{src:n["thumb-small"]||"/plug-m.png",srcSet:`
              ${n["thumb-medium"]||"/plug-m.png"} 480w,
              ${n.ingredientThumb||"/plug-b.png"} 748w
            `,sizes:"(min-width: 1200px) 270px, (min-width:768px) 354px, (min-width:480px) 450px, 100vw",alt:n.title,loading:"lazy"}),x.jsxs(bW,{children:[x.jsx(wW,{children:n.title}),x.jsx(vW,{children:n.measure})]})]},r))})]})};JC.propTypes={ingridients:Q.object,ingredients:Q.array,title:Q.string,measure:Q.string,ingredientThumb:Q.string};const CW=A.div`
padding-top:40px;
padding-bottom:80px;
@media ${e=>e.theme.device.tablet}{
    padding-top:50px;
...
`,QC=({ingridients:{description:e,instructions:t,drinkThumb:n,drink:r}})=>{const i=t.split(new RegExp("(?<=[.!?])\\s+")).filter(Boolean);return x.jsxs(CW,{children:[x.jsx(TW,{children:"Recipe Preparation"}),x.jsxs(kW,{children:[x.jsxs(AW,{children:[x.jsxs(OW,{children:[e||"Lorem ipsum dolor sit amet consectetur adipisicing elit. Praesentium debitis optio deserunt dignissimos commodi nisi expedita itaque dolor provident. Atque labore, corrupti totamaccusantium omnis alias vero. Itaque eos ullam aut rerum quam. Nontemporibus vel dolore similique, suscipit amet."," "]}),x.jsx(_W,{children:i.map((o,s)=>x.jsx($W,{children:x.jsx(PW,{children:o.trim()})},s))})]}),x.jsx(RW,{children:x.jsx(jW,{src:n||"/plug-m.png",alt:r})})]})]})};QC.propTypes={ingridients:Q.object,drink:Q.string,drinkThumb:Q.string,description:Q.string,instructions:Q.string};const IW=async e=>{try{const{data:t}=await $e.get(`/recipes/${e}`);return t}catch(t){return t.response.data.message}},MW=()=>{const{recipeId:e}=jx(),[t,n]=b.useState(null);return b.useEffect(()=>{IW(e).then(r=>n(r))},[e]),x.jsx("div",{children:x.jsxs(kn,{children:[t&&x.jsx(XC,{ingridients:t}),t&&x.jsx(JC,{ingridients:t}),t&&x.jsx(QC,{ingridients:t})]})})},FW=()=>x.jsx(kn,{children:x.jsx(Oa,{children:x.jsxs(oH,{children:[x.jsx(rx,{children:"4"}),x.jsx(rx,{children:"4"})]})})}),zf=bt("@@cocktails/categoriesList",async(e,{rejectWithValue:t,getState:n})=>{const r=Wc(n());try{return Vi(r),(await $e.get("recipes/category-list")).data}catch(i){return t(i.response.status)}}),Nf=bt("@@cocktails/byId",async(e,{rejectWithValue:t,getState:n})=>{const r=Wc(n());if(!r)return t();Vi(r);try{return(await $e.get(`recipes/id/${e}`)).data}catch(i){return t(i.response.status)}});bt("@@cocktails/addRecipe",async(e,{rejectWithValue:t,getState:n})=>{const r=Wc(n());if(!r)return t();Vi(r);try{let i=null;return e.get("drinkThumb")?i=await $e.post("own",e,{headers:{"Content-Type":"multipart/form-data"}}):i=await $e.post("own",e),i.data}catch(i){return t(i.response.status)}});const Vf=bt("@@cocktails/ownCocktails",async({page:e,limit:t},{rejectWithValue:n,getState:r})=>{const i=Wc(r());if(!i)return n();Vi(i);const o={};o.page=e,o.limit=t;try{const s=await $e.get("/own",{params:o});return console.log(s),s.data}catch(s){return n(s.response.status)}}),LW=async()=>{try{return await $e.get("/own")}catch(e){return e.response.data.message}},DW=()=>{const[e,t]=b.useState([]);return b.useEffect(()=>{LW().then(n=>t(n.data.cocktails))},[]),x.jsx(KC,{children:e.length>0?x.jsx(qC,{children:e.map(n=>x.jsx(Ng,{page:"my",cocktail:n},n._id))}):x.jsxs(x.Fragment,{children:[x.jsx(Oa,{}),x.jsx(Ah,{children:"You haven't added any cocktail recipes yet"})]})})};A.section`
  padding-top: 80px;
  padding-bottom: 80px;
  @media (min-width: 768px) {
    padding-top: 140px;
...
`;const zW=()=>(b.useEffect(()=>{window.scrollTo(0,0)},[]),x.jsx(x.Fragment,{children:x.jsx(kn,{children:x.jsxs(x.Fragment,{children:[x.jsx(as,{title:"My recipes"}),x.jsx(DW,{})]})})})),di=({component:e,redirectTo:t="/"})=>{const n=nt(Vm),r=nt(t2);return!n&&!r?x.jsx(Mx,{to:t}):e};di.propTypes={component:Q.object,redirectTo:Q.string};const Ql=({component:e,redirectTo:t="/"})=>nt(Vm)?x.jsx(Mx,{to:t}):e;Ql.propTypes={component:Q.object,redirectTo:Q.string};const NW={success:{style:{background:"#66BB6A",border:"1px solid ##66BB6A",borderRadius:"4px",color:"white"},icon:null},error:{style:{background:"#E57373",border:"1px solid #FF5733",borderRadius:"4px",color:"white"},icon:null}};function VW(){const e=qn(),t=nt(t2),n=nt(Fg);return b.useEffect(()=>{e(Bl())},[e]),b.useEffect(()=>{},[n]),t?x.jsx(Tg,{}):x.jsx(bk,{theme:Lg(n),children:x.jsxs(uW,{children:[x.jsxs(ST,{children:[x.jsx(nn,{index:!0,element:x.jsx(Ql,{component:x.jsx(Qk,{}),redirectTo:"/main"})}),x.jsx(nn,{path:"/signin",element:x.jsx(Ql,{component:x.jsx(nL,{}),redirectTo:"/main"})}),x.jsx(nn,{path:"/signup",element:x.jsx(Ql,{component:x.jsx(iL,{}),redirectTo:"/main"})}),x.jsxs(nn,{path:"/",element:x.jsx(X5,{}),children:[x.jsx(nn,{path:"/main",element:x.jsx(di,{component:x.jsx(pD,{})})}),x.jsx(nn,{path:"/drinks",element:x.jsx(di,{component:x.jsx(aH,{})})}),x.jsx(nn,{path:"/add",element:x.jsx(di,{component:x.jsx(WH,{})})}),x.jsx(nn,{path:"/recipe/:recipeId",element:x.jsx(di,{component:x.jsx(MW,{})})}),x.jsx(nn,{path:"/my",element:x.jsx(di,{component:x.jsx(zW,{})})}),x.jsx(nn,{path:"/favorite",element:x.jsx(di,{component:x.jsx(lW,{})})}),x.jsx(nn,{path:"*",element:x.jsx(FW,{})})]})]}),x.jsx(Tj,{toastOptions:NW})]})})}var s0="persist:",ZC="persist/FLUSH",a0="persist/REHYDRATE",e4="persist/PAUSE",t4="persist/PERSIST",n4="persist/PURGE",r4="persist/REGISTER",BW=-1;function Zl(e){return typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?Zl=function(n){return typeof n}:Zl=function(n){return n&&typeof Symbol=="function"&&n.constructor===Symbol&&n!==Symbol.prototype?"symbol":typeof n},Zl(e)}function dx(e,t){var n=Object.keys(e);if(Object.getOwnPropertySymbols){var r=Object.getOwnPropertySymbols(e);t&&(r=r.filter(function(i){return Object.getOwnPropertyDescriptor(e,i).enumerable})),n.push.apply(n,r)}return n}function UW(e){for(var t=1;t<arguments.length;t++){var n=arguments[t]!=null?arguments[t]:{};t%2?dx(n,!0).forEach(function(r){HW(e,r,n[r])}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(n)):dx(n).forEach(function(r){Object.defineProperty(e,r,Object.getOwnPropertyDescriptor(n,r))})}return e}function HW(e,t,n){return t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}function WW(e,t,n,r){r.debug;var i=UW({},n);return e&&Zl(e)==="object"&&Object.keys(e).forEach(function(o){o!=="_persist"&&t[o]===n[o]&&(i[o]=e[o])}),i}function GW(e){var t=e.blacklist||null,n=e.whitelist||null,r=e.transforms||[],i=e.throttle||0,o="".concat(e.keyPrefix!==void 0?e.keyPrefix:s0).concat(e.key),s=e.storage,a;e.serialize===!1?a=function(E){return E}:typeof e.serialize=="function"?a=e.serialize:a=KW;var l=e.writeFailHandler||null,u={},c={},d=[],f=null,p=null,v=function(E){Object.keys(E).forEach(function(C){g(C)&&u[C]!==E[C]&&d.indexOf(C)===-1&&d.push(C)}),Object.keys(u).forEach(function(C){E[C]===void 0&&g(C)&&d.indexOf(C)===-1&&u[C]!==void 0&&d.push(C)}),f===null&&(f=setInterval(h,i)),u=E};function h(){if(d.length===0){f&&clearInterval(f),f=null;return}var S=d.shift(),E=r.reduce(function(C,T){return T.in(C,S,u)},u[S]);if(E!==void 0)try{c[S]=a(E)}catch(C){console.error("redux-persist/createPersistoid: error serializing state",C)}else delete c[S];d.length===0&&w()}function w(){Object.keys(c).forEach(function(S){u[S]===void 0&&delete c[S]}),p=s.setItem(o,a(c)).catch(m)}function g(S){return!(n&&n.indexOf(S)===-1&&S!=="_persist"||t&&t.indexOf(S)!==-1)}function m(S){l&&l(S)}var y=function(){for(;d.length!==0;)h();return p||Promise.resolve()};return{update:v,flush:y}}function KW(e){return JSON.stringify(e)}function qW(e){var t=e.transforms||[],n="".concat(e.keyPrefix!==void 0?e.keyPrefix:s0).concat(e.key),r=e.storage;e.debug;var i;return e.deserialize===!1?i=function(s){return s}:typeof e.deserialize=="function"?i=e.deserialize:i=YW,r.getItem(n).then(function(o){if(o)try{var s={},a=i(o);return Object.keys(a).forEach(function(l){s[l]=t.reduceRight(function(u,c){return c.out(u,l,a)},i(a[l]))}),s}catch(l){throw l}else return})}function YW(e){return JSON.parse(e)}function XW(e){var t=e.storage,n="".concat(e.keyPrefix!==void 0?e.keyPrefix:s0).concat(e.key);return t.removeItem(n,JW)}function JW(e){}function fx(e,t){var n=Object.keys(e);if(Object.getOwnPropertySymbols){var r=Object.getOwnPropertySymbols(e);t&&(r=r.filter(function(i){return Object.getOwnPropertyDescriptor(e,i).enumerable})),n.push.apply(n,r)}return n}function er(e){for(var t=1;t<arguments.length;t++){var n=arguments[t]!=null?arguments[t]:{};t%2?fx(n,!0).forEach(function(r){QW(e,r,n[r])}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(n)):fx(n).forEach(function(r){Object.defineProperty(e,r,Object.getOwnPropertyDescriptor(n,r))})}return e}function QW(e,t,n){return t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}function ZW(e,t){if(e==null)return{};var n=eG(e,t),r,i;if(Object.getOwnPropertySymbols){var o=Object.getOwnPropertySymbols(e);for(i=0;i<o.length;i++)r=o[i],!(t.indexOf(r)>=0)&&Object.prototype.propertyIsEnumerable.call(e,r)&&(n[r]=e[r])}return n}function eG(e,t){if(e==null)return{};var n={},r=Object.keys(e),i,o;for(o=0;o<r.length;o++)i=r[o],!(t.indexOf(i)>=0)&&(n[i]=e[i]);return n}var tG=5e3;function Ga(e,t){var n=e.version!==void 0?e.version:BW;e.debug;var r=e.stateReconciler===void 0?WW:e.stateReconciler,i=e.getStoredState||qW,o=e.timeout!==void 0?e.timeout:tG,s=null,a=!1,l=!0,u=function(d){return d._persist.rehydrated&&s&&!l&&s.update(d),d};return function(c,d){var f=c||{},p=f._persist,v=ZW(f,["_persist"]),h=v;if(d.type===t4){var w=!1,g=function(j,O){w||(d.rehydrate(e.key,j,O),w=!0)};if(o&&setTimeout(function(){!w&&g(void 0,new Error('redux-persist: persist timed out for persist key "'.concat(e.key,'"')))},o),l=!1,s||(s=GW(e)),p)return er({},t(h,d),{_persist:p});if(typeof d.rehydrate!="function"||typeof d.register!="function")throw new Error("redux-persist: either rehydrate or register is not a function on the PERSIST action. This can happen if the action is being replayed. This is an unexplored use case, please open an issue and we will figure out a resolution.");return d.register(e.key),i(e).then(function(T){var j=e.migrate||function(O,P){return Promise.resolve(O)};j(T,n).then(function(O){g(O)},function(O){g(void 0,O)})},function(T){g(void 0,T)}),er({},t(h,d),{_persist:{version:n,rehydrated:!1}})}else{if(d.type===n4)return a=!0,d.result(XW(e)),er({},t(h,d),{_persist:p});if(d.type===ZC)return d.result(s&&s.flush()),er({},t(h,d),{_persist:p});if(d.type===e4)l=!0;else if(d.type===a0){if(a)return er({},h,{_persist:er({},p,{rehydrated:!0})});if(d.key===e.key){var m=t(h,d),y=d.payload,S=r!==!1&&y!==void 0?r(y,c,m,e):m,E=er({},S,{_persist:er({},p,{rehydrated:!0})});return u(E)}}}if(!p)return t(c,d);var C=t(h,d);return C===h?c:u(er({},C,{_persist:p}))}}function px(e){return iG(e)||rG(e)||nG()}function nG(){throw new TypeError("Invalid attempt to spread non-iterable instance")}function rG(e){if(Symbol.iterator in Object(e)||Object.prototype.toString.call(e)==="[object Arguments]")return Array.from(e)}function iG(e){if(Array.isArray(e)){for(var t=0,n=new Array(e.length);t<e.length;t++)n[t]=e[t];return n}}function hx(e,t){var n=Object.keys(e);if(Object.getOwnPropertySymbols){var r=Object.getOwnPropertySymbols(e);t&&(r=r.filter(function(i){return Object.getOwnPropertyDescriptor(e,i).enumerable})),n.push.apply(n,r)}return n}function _h(e){for(var t=1;t<arguments.length;t++){var n=arguments[t]!=null?arguments[t]:{};t%2?hx(n,!0).forEach(function(r){oG(e,r,n[r])}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(n)):hx(n).forEach(function(r){Object.defineProperty(e,r,Object.getOwnPropertyDescriptor(n,r))})}return e}function oG(e,t,n){return t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}var i4={registry:[],bootstrapped:!1},sG=function(){var t=arguments.length>0&&arguments[0]!==void 0?arguments[0]:i4,n=arguments.length>1?arguments[1]:void 0;switch(n.type){case r4:return _h({},t,{registry:[].concat(px(t.registry),[n.key])});case a0:var r=t.registry.indexOf(n.key),i=px(t.registry);return i.splice(r,1),_h({},t,{registry:i,bootstrapped:i.length===0});default:return t}};function aG(e,t,n){var r=n||!1,i=ig(sG,i4,t&&t.enhancer?t.enhancer:void 0),o=function(u){i.dispatch({type:r4,key:u})},s=function(u,c,d){var f={type:a0,payload:c,err:d,key:u};e.dispatch(f),i.dispatch(f),r&&a.getState().bootstrapped&&(r(),r=!1)},a=_h({},i,{purge:function(){var u=[];return e.dispatch({type:n4,result:function(d){u.push(d)}}),Promise.all(u)},flush:function(){var u=[];return e.dispatch({type:ZC,result:function(d){u.push(d)}}),Promise.all(u)},pause:function(){e.dispatch({type:e4})},persist:function(){e.dispatch({type:t4,register:o,rehydrate:s})}});return t&&t.manualPersist||a.persist(),a}var l0={},u0={};u0.__esModule=!0;u0.default=cG;function eu(e){return typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?eu=function(n){return typeof n}:eu=function(n){return n&&typeof Symbol=="function"&&n.constructor===Symbol&&n!==Symbol.prototype?"symbol":typeof n},eu(e)}function Bf(){}var lG={getItem:Bf,setItem:Bf,removeItem:Bf};function uG(e){if((typeof self>"u"?"undefined":eu(self))!=="object"||!(e in self))return!1;try{var t=self[e],n="redux-persist ".concat(e," test");t.setItem(n,"test"),t.getItem(n),t.removeItem(n)}catch{return!1}return!0}function cG(e){var t="".concat(e,"Storage");return uG(t)?self[t]:lG}l0.__esModule=!0;l0.default=pG;var dG=fG(u0);function fG(e){return e&&e.__esModule?e:{default:e}}function pG(e){var t=(0,dG.default)(e);return{getItem:function(r){return new Promise(function(i,o){i(t.getItem(r))})},setItem:function(r,i){return new Promise(function(o,s){o(t.setItem(r,i))})},removeItem:function(r){return new Promise(function(i,o){i(t.removeItem(r))})}}}var us=void 0,hG=mG(l0);function mG(e){return e&&e.__esModule?e:{default:e}}var gG=(0,hG.default)("local");us=gG;const vG={user:{name:null,email:null,avatarURL:null},token:null,isLoggedIn:!1,isRefreshing:!0,error:""},yG=e=>{e.error=""},xG=(e,t)=>{e.error=t.payload},bG=rs({name:"auth",initialState:vG,extraReducers:e=>e.addCase(Y2.fulfilled,(t,n)=>{t.user=n.payload.user,t.token=n.payload.token,t.isLoggedIn=!0,t.isRefreshing=!1}).addCase(th.fulfilled,(t,n)=>{t.user=n.payload.user,t.token=n.payload.token,t.isLoggedIn=!0,t.isRefreshing=!1}).addCase(th.rejected,(t,n)=>{t.isLoggedIn=!1,t.isRefreshing=!1,t.error=n.payload.message}).addCase(X2.fulfilled,t=>{t.user={name:null,email:null},t.token=null,t.isLoggedIn=!1,t.isRefreshing=!1}).addCase(Bl.pending,t=>{t.isRefreshing=!0}).addCase(Bl.fulfilled,(t,n)=>{t.user=n.payload,t.isLoggedIn=!0,t.isRefreshing=!1}).addCase(Bl.rejected,t=>{t.isRefreshing=!1}).addCase(J2.fulfilled,(t,n)=>{t.user.avatarURL=n.payload,t.isRefreshing=!1}).addCase(Q2.fulfilled,(t,n)=>{t.user.name=n.payload,t.isRefreshing=!1}).addMatcher(t=>t.type.endsWith("/pending"),yG).addMatcher(t=>t.type.endsWith("/rejected"),xG)}),wG=bG.reducer,SG={key:"auth",storage:us,whitelist:["token"]},EG=Ga(SG,wG),Uf=bt("/auth/subscribe",async(e,t)=>{try{return(await $e.post("/subscribe",e)).data}catch(n){return ut.error("Something wrong. Try again."),t.rejectWithValue(n.response.data.message)}}),CG=rs({name:"subscribe",initialState:{subscription:null,isLoading:!1,error:""},extraReducers:e=>{e.addCase(Uf.pending,t=>{t.isLoading=!0}).addCase(Uf.fulfilled,(t,n)=>{t.isLoading=!1,ut.success("Thank you for subscribing to our news.")}).addCase(Uf.rejected,(t,n)=>{t.isRefreshing=!1,ut.error(n.payload)})}}),TG=CG.reducer,Hf=e=>{e.isLoading=!0,e.error=null},Wf=(e,t)=>{e.isLoading=!1,e.error=t.payload},OG=rs({name:"favorites",initialState:{items:[],isLoading:!1,error:null},extraReducers:{[Io.pending]:Hf,[Jl.pending]:Hf,[Xs.pending]:Hf,[Io.rejected]:Wf,[Jl.rejected]:Wf,[Xs.rejected]:Wf,[Io.fulfilled](e,t){e.isLoading=!1,e.error=null,e.items=t.payload.drinks},[Jl.fulfilled](e,t){e.isLoading=!1,e.error=null,e.items.push(t.payload)},[Xs.fulfilled](e,t){e.isLoading=!1,e.error=null,e.items=e.items.filter(n=>n._id!==t.payload.recipeId)}}}),PG=OG.reducer,kG={key:"favoriteRecipe",storage:us,whitelist:["drink","categories","_id","description","glass","drinkThumb"]},AG=Ga(kG,PG),_G={cocktails:[],own:[],popular:[],categories:[],search:{query:"",chosenCategory:"",chosenIngredient:""},totalHits:null,page:1,loading:!1},$G=rs({name:"@@cocktails",initialState:_G,reducers:{setQuery:(e,{payload:t})=>{e.search.query=t},setChosenCategory:(e,{payload:t})=>{e.search.chosenCategory=t},setChosenIngredient:(e,{payload:t})=>{e.search.chosenIngredient=t},setPage:(e,{payload:t})=>{e.page=t}},extraReducers:{[zf.pending]:e=>{e.loading=!0},[zf.fulfilled]:(e,{payload:t})=>{e.categories=t,e.loading=!1},[zf.rejected]:(e,{payload:t})=>{e.error=t,e.loading=!1},[Nf.pending]:e=>{e.loading=!0},[Nf.fulfilled]:(e,{payload:t})=>{e.favorites=t,e.backup=t,e.loading=!1},[Nf.rejected]:(e,{payload:t})=>{e.error=t,e.loading=!1},[Vf.pending]:e=>{e.loading=!0},[Vf.fulfilled]:(e,{payload:t})=>{e.own=t.cocktails,e.totalHits=t.totalHits,e.loading=!1},[Vf.rejected]:(e,{payload:t})=>{e.error=t,e.loading=!1}}}),jG=$G.reducer,RG={categories:[],ingredients:[],glasses:[],isLoading:!1,error:""},IG=e=>{e.isLoading=!0,e.error=""},MG=(e,t)=>{e.isLoading=!1,e.error=t.payload},FG=rs({name:"drinksQuery",initialState:RG,extraReducers:e=>e.addCase(Vg.fulfilled,(t,n)=>{t.categories=n.payload,t.isLoading=!1,t.error=""}).addCase(Bg.fulfilled,(t,n)=>{t.ingredients=n.payload,t.isLoading=!1,t.error=""}).addCase(HE.fulfilled,(t,n)=>{t.glasses=n.payload,t.isLoading=!1,t.error=""}).addMatcher(t=>t.type.endsWith("/pending"),IG).addMatcher(t=>t.type.endsWith("/rejected"),MG)}),LG=FG.reducer,DG={key:"drinksQuery",storage:us,whitelist:["categories","ingredients","glasses"]},zG=Ga(DG,LG),NG=rs({name:"theme",initialState:{theme:"dark"},reducers:{toggleTheme:e=>{e.theme=e.theme==="light"?"dark":"light"}}}),VG=NG.reducer,BG={key:"theme",storage:us},UG=Ga(BG,VG),HG={key:"cocktails",version:3,storage:us,whitelist:["cocktails","categories"]},o4=HA({reducer:{auth:EG,subscribe:TG,favorites:AG,cocktails:Ga(HG,jG),drinksQuery:zG,theme:UG},middleware:e=>e({serializableCheck:!1})}),WG=aG(o4);function tu(e){return typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?tu=function(n){return typeof n}:tu=function(n){return n&&typeof Symbol=="function"&&n.constructor===Symbol&&n!==Symbol.prototype?"symbol":typeof n},tu(e)}function GG(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function mx(e,t){for(var n=0;n<t.length;n++){var r=t[n];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}function KG(e,t,n){return t&&mx(e.prototype,t),n&&mx(e,n),e}function qG(e,t){return t&&(tu(t)==="object"||typeof t=="function")?t:nu(e)}function $h(e){return $h=Object.setPrototypeOf?Object.getPrototypeOf:function(n){return n.__proto__||Object.getPrototypeOf(n)},$h(e)}function nu(e){if(e===void 0)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return e}function YG(e,t){if(typeof t!="function"&&t!==null)throw new TypeError("Super expression must either be null or a function");e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,writable:!0,configurable:!0}}),t&&jh(e,t)}function jh(e,t){return jh=Object.setPrototypeOf||function(r,i){return r.__proto__=i,r},jh(e,t)}function ru(e,t,n){return t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}var s4=function(e){YG(t,e);function t(){var n,r;GG(this,t);for(var i=arguments.length,o=new Array(i),s=0;s<i;s++)o[s]=arguments[s];return r=qG(this,(n=$h(t)).call.apply(n,[this].concat(o))),ru(nu(r),"state",{bootstrapped:!1}),ru(nu(r),"_unsubscribe",void 0),ru(nu(r),"handlePersistorState",function(){var a=r.props.persistor,l=a.getState(),u=l.bootstrapped;u&&(r.props.onBeforeLift?Promise.resolve(r.props.onBeforeLift()).finally(function(){return r.setState({bootstrapped:!0})}):r.setState({bootstrapped:!0}),r._unsubscribe&&r._unsubscribe())}),r}return KG(t,[{key:"componentDidMount",value:function(){this._unsubscribe=this.props.persistor.subscribe(this.handlePersistorState),this.handlePersistorState()}},{key:"componentWillUnmount",value:function(){this._unsubscribe&&this._unsubscribe()}},{key:"render",value:function(){return typeof this.props.children=="function"?this.props.children(this.state.bootstrapped):this.state.bootstrapped?this.props.children:this.props.loading}}]),t}(b.PureComponent);ru(s4,"defaultProps",{children:null,loading:null});Xf.createRoot(document.getElementById("root")).render(x.jsx(ie.StrictMode,{children:x.jsx(_P,{store:o4,children:x.jsx(s4,{loading:null,persistor:WG,children:x.jsx(AT,{basename:"/project-drink-master/",children:x.jsx(VW,{})})})})}))});export default XG();
