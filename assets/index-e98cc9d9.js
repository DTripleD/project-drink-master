...
`,sH=()=>{const{state:e}=zt(),t=qn(),{register:n,handleSubmit:r,control:i}=yg(),[o,s]=b.useState(1),[a,l]=b.useState(1),[u,c]=b.useState([]),[d,f]=b.useState(""),[p,v]=b.useState(()=>window.innerWidth>=1440?9:10),[h,w]=Lx({search:"",category:e!=null&&e.category?e==null?void 0:e.category:"Cocktail",ingredients:"",page:o,limit:p}),g=new URLSearchParams(h.toString());b.useEffect(()=>{t(Vg()),t(Bg())},[]),b.useEffect(()=>{const k=()=>{window.innerWidth>=1440?v(9):v(10)};return window.addEventListener("resize",k),()=>window.removeEventListener("resize",k)},[]);const m=nt(BE),y=nt(ED);b.useEffect(()=>{const k=parseInt(h.get("page"))||1;k!==o&&s(k),p9(h).then(O=>{c(O),f(O),l(Math.ceil(O.totalHits/p))}).catch(O=>{f(O)})},[h]);const S=m.map(k=>({value:k,label:k})),E=y.map(k=>({value:k,label:k}));E.push({value:"Ingredients",label:"Ingredients"});const C=k=>{var O,$;w({search:(k==null?void 0:k.search)||"",category:((O=k==null?void 0:k.category)==null?void 0:O.label)||(e==null?void 0:e.category)||"",ingredients:(($=k==null?void 0:k.ingredients)==null?void 0:$.label)||"",page:"1",limit:p})},T=(k,O)=>{g.set("page",O.toString()),w(g),s(O)};return x.jsxs(x.Fragment,{children:[x.jsxs(u9,{onSubmit:r(C),children:[x.jsxs(c9,{children:[x.jsx(d9,{type:"text",...n("search"),placeholder:"Enter the text"}),x.jsx(f9,{type:"submit",children:x.jsx(hD,{style:{width:20,height:20}})})]}),x.jsx(Vu,{control:i,name:"category",render:({field:{onChange:k,value:O}})=>x.jsx(j1,{defaultValue:S[1],options:S,value:O,onChange:k,classNamePrefix:"select"})}),x.jsx(Vu,{control:i,name:"ingredients",render:({field:{onChange:k,value:O}})=>x.jsx(j1,{defaultValue:E[100],options:E,value:O,onChange:k,classNamePrefix:"select"})})]}),!u.drinks&&!d&&x.jsx("h2",{children:"Loading..."}),x.jsx(VE,{drinks:u.drinks}),d==="drinks not found"&&x.jsxs(x.Fragment,{children:[x.jsx(Oa,{}),x.jsx(wD,{children:"Unfortunately, there is no such cocktails.... 😭"})]}),a>1&&x.jsx(i0,{totalPages:a,page:o,changeNum:T})]})},aH=()=>x.jsx("div",{children:x.jsxs(kn,{children:[x.jsx(as,{title:"Drinks"}),x.jsx(sH,{})]})}),lH=A.div`
	display: flex;
	flex-direction: column;
	gap: 40px;
	@media (min-width: 768px) {
