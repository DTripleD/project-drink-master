import{n as t,P as d,j as e,h as l,a as y,b as J,c as j,r as c,t as k,M as z,v as x,w as T}from"./index-88cbaa89.js";import{M as K}from"./MainPageTitle-9226b7fa.js";import{s as h,a as v}from"./favorite-selector-94e92a4d.js";import{S as F,D as L}from"./DeleteButton-28b468e1.js";import{S as M,M as Z,a as B}from"./RecipesList.styled-aeb2fdeb.js";import{P as H}from"./Pagination-5bb148aa.js";import{E as R}from"./ErrorPage.styled-3e6ef58c.js";import"./assertThisInitialized-9773c2e6.js";import"./white-bg@2x-60be6de5.js";const G=t.div`
  display: flex;
...
`;const te=()=>{J();const i=j(),n=l(v);l(h);const[o,s]=c.useState(()=>window.innerWidth>=1440?9:8);c.useEffect(()=>{const a=()=>{window.innerWidth>=1440?s(9):s(8)};return window.addEventListener("resize",a),()=>window.removeEventListener("resize",a)},[]);const[p,w]=c.useState(1),A=p*o,C=A-o,g=n.slice(C,A),[m,I]=c.useState(1);c.useEffect(()=>{i(k()),I(Math.ceil(n.length/o))},[]);const u=a=>{x.success("Deleting..."),i(T(a)).unwrap().then(r=>{I(Math.ceil(r.totalHits/o))}).then(()=>x.success("Delete success!"))},b=(a,r)=>{w(r)};return e.jsx(e.Fragment,{children:e.jsx(z,{children:e.jsxs(e.Fragment,{children:[e.jsx(K,{title:"Favorites"}),(g==null?void 0:g.length)!==0?e.jsx(V,{handleDeleteFavorite:u,currentItems:g}):e.jsxs(e.Fragment,{children:[e.jsx(R,{}),e.jsx(B,{children:"You havent added any favorite cocktails yet"})]}),m>1&&e.jsx(H,{totalPages:m,page:p,changeNum:b})]})})})};export{te as default};
