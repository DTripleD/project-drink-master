...
`;const fV=()=>{const e=gr();return x.jsx(An,{children:x.jsx(uV,{children:x.jsxs(cV,{children:[x.jsx(us,{title:"Craft Your Perfect Drink with Drink Master"}),x.jsx(dV,{children:"Unlock your inner mixologist with Drink Master, your one- stop destination for exploring, crafting, and mastering the worlds finest beverages."}),x.jsx(hC,{text:"Add Recipe",ariaLabel:"Button to open Add Recipe Page",onClick:()=>{e("/add")}})]})})})},pV=_.div`
  display: flex;
  justify-content: center;
`,hV=_(Pi)`
  /* width: 151px;
...
`,fW=()=>x.jsx(x.Fragment,{children:x.jsx(An,{children:x.jsxs(dW,{children:[x.jsx(us,{title:"Favorites"}),x.jsx(cW,{})]})})}),pW=_.div`
  width: 100%;
