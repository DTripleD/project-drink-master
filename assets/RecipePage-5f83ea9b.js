import{n as i,P as s,j as t,x as h,r as d,h as f,c as v,t as w,y as $,w as j,i as y,M as z,a as I}from"./index-3c6cd029.js";import{a as k}from"./favorite-selector-94e92a4d.js";const P=i.h1`
...
`,u=({ingridients:e})=>{if(!e)return t.jsx(m,{children:"Something went wrong,try again..."});const o=e.ingredients;return t.jsxs(B,{children:[t.jsx(m,{children:"Ingredients"}),t.jsx(A,{children:o.map((n,r)=>t.jsxs(C,{children:[t.jsx(E,{src:n["thumb-small"]||"/plug-m.png",srcSet:`
            ...
            `,sizes:"(min-width: 1200px) 270px, (min-width:768px) 354px, (min-width:480px) 450px, 100vw",alt:n.title,loading:"lazy"}),t.jsxs(M,{children:[t.jsx(V,{children:n.title}),t.jsx(D,{children:n.measure})]})]},r))})]})};u.propTypes={ingridients:s.object,ingredients:s.array,title:s.string,measure:s.string,ingredientThumb:s.string};const G=i.div`
padding-top:40px;
padding-bottom:80px;
@media ${e=>e.theme.device.tablet}{
    padding-top:50px;
